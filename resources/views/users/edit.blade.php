...
@section('content')
    ...
    <div class="content-box"> <!-- Content-Box  -->
        <div class="content-box-header">
            ...
            <!-- Botoes (com icones)  -->
            <x-action-buttons :list="route('users.index')" :password="route('users.password.edit', $user)" :delete="route('users.destroy', $user)" can-list="index-user"
                can-password="edit-user" can-delete="destroy-user"
