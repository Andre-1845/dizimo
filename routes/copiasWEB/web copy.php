...
Route::middleware(['auth', 'verified', 'permission:manage-site-content'])
    ...
    ->group(function () {
        ...
        Route::get('/sections', [SiteSectionController::class, 'index'])
            ->name('admin.site.sections.index');

        Route::get('/sections/{section}/edit', [SiteSectionController::class, 'edit'])
            ->name('admin.site.sections.edit');

        Route::put('/sections/{section}', [SiteSectionController::class, 'update'])
            ->name('admin.site.sections.update');

        // Agenda
        Route::resource('/events', SiteEventController::class)
            ->names('admin.site.events');
